    ...
    public class AuthFactorySuiteController : ApiController
    {
        ...
        public async Task<IHttpActionResult> Token()
        {
            try
            {
                ...
                var resultValidation = ValidateToken_ad(token, ref userid, ref firmas);


                var userToken = new UserToken { IdToken = token, AD = firmas };
        ...
        private bool ValidateToken_ad(string token, ref string userid, ref Int32 firmas)
        {
